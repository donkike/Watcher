...
CREATE TABLE movie (id BIGINT AUTO_INCREMENT, title VARCHAR(255) NOT NULL UNIQUE, director_id BIGINT NOT NULL, genre_id BIGINT NOT NULL, year BIGINT NOT NULL, synopsis TEXT, image_link VARCHAR(255) UNIQUE, trailer_link VARCHAR(255) UNIQUE, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX director_id_idx (director_id), INDEX genre_id_idx (genre_id), PRIMARY KEY(id)) ENGINE = INNODB;
